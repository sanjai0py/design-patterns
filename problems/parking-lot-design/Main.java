...
public class ParkingSlot {
    ...
    ParkingSlot(String slotId, String slotNumber, ParkingStatus status, SlotSize slotSize) {
        this.slotId = slotId;
...
public class Floor {
    ...
    Floor(String floorId, int floorNumber, String floorName, List<ParkingSlot> parkingSlots) {
...
public class Parking {
    ...
    Parking(String parkingId, List<Floor> floors, String parkingName, String address) {
